        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="/customService/information" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">新邮箱地址</label>
                                <input type="email" class="form-control" id="exampleInputEmail1"
                                       placeholder="Enter email" name="newEmail">
                            </div>
                ...
                <div class="card card-primary">
                    ...
                    <form>
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">旧用户密码</label>
                                <input type="password" class="form-control" id="exampleInputEmail1"
                                       placeholder="Enter old password" name="oldPassword">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">新用户密码</label>
                                <input type="password" class="form-control" id="exampleInputEmail1"
                                       placeholder="Enter new password" name="newPassword">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">再次输入新用户密码</label>
                                <input type="password" class="form-control" id="exampleInputEmail1"
                                       placeholder="Enter new password again" name="rePassword">
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Check me out</label>
                        ...
                        <div class="card-footer">
                            <button onclick="infoAlert()" type="submit" class="btn btn-primary">Submit</button>
                        </div>
                    </form>
                    <!-- /.card -->
                </div>
